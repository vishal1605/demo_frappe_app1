...
import parent_app
from parent_app.accounts.doctype.payment_entry.payment_entry import (
	PaymentEntry,
	get_bank_cash_account,
	get_reference_details,
)
from parent_app.accounts.utils import get_account_currency
from parent_app.setup.utils import get_exchange_rate

from hrdemo.hr.doctype.expense_claim.expense_claim import get_outstanding_amount_for_claim
...
def get_reference_details_for_employee(reference_doctype, reference_name, party_account_currency):
	...
	company_currency = ref_doc.get("company_currency") or parent_app.get_company_currency(
		ref_doc.company
	)
