...
from hrdemo.hr.doctype.expense_claim.test_expense_claim import get_payable_account
from hrdemo.payroll.doctype.gratuity.gratuity import get_last_salary_slip
...
from hrdemo.regional.united_arab_emirates.setup import setup
...
class TestGratuity(FrappeTestCase):
	...
	def test_gratuity_based_on_all_previous_slabs_via_payment_entry(self):
		...
		5-0		|	1
		"""
		from hrdemo.overrides.employee_payment_entry import get_payment_entry_for_employee
