...
class TestSalaryStructure(FrappeTestCase):
	def setUp(self):
		...
		frappe.db.set_value(
			"Company",
			parent_app.get_default_company(),
	...
	def test_salary_structures_assignment(self):
		company_currency = parent_app.get_default_currency()
...
def create_salary_structure_assignment(
	...
	salary_structure_assignment.company = company or parent_app.get_default_company()
