...
{% include "parent_app/public/js/controllers/accounts.js" %}
...
frappe.ui.form.on('Salary Structure', {
	...
	set_earning_deduction_component: function(frm) {
		...
		frm.set_query("salary_component", "earnings", function() {
			return {
				...
				query: "hrdemo.payroll.doctype.salary_structure.salary_structure.get_salary_component"
			};
		});
	...
	preview_salary_slip: function(frm) {
		frappe.call({
			method: "hrdemo.payroll.doctype.salary_structure.salary_structure.get_employees",
			args: {
	...
	open_salary_slip: function(frm, employee){
		...
		frappe.call({
			method: "hrdemo.payroll.doctype.salary_structure.salary_structure.make_salary_slip",
			args: {
