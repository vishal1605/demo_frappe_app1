...
from parent_app.loan_management.doctype.loan_repayment.loan_repayment import (
	calculate_amounts,
...
from parent_app.utilities.transaction_base import TransactionBase

from hrdemo.hr.utils import get_holiday_dates_for_employee, validate_active_employee
from hrdemo.payroll.doctype.additional_salary.additional_salary import get_additional_salaries
from hrdemo.payroll.doctype.employee_benefit_application.employee_benefit_application import (
	get_benefit_component_amount,
)
from hrdemo.payroll.doctype.employee_benefit_claim.employee_benefit_claim import (
	get_benefit_claim_amount,
	get_last_payroll_period_benefits,
)
from hrdemo.payroll.doctype.payroll_entry.payroll_entry import get_start_end_dates
from hrdemo.payroll.doctype.payroll_period.payroll_period import (
	get_payroll_period,
	get_period_factor,
)
...
class SalarySlip(TransactionBase):
	...
	def set_net_total_in_words(self):
		...
		company_currency = parent_app.get_company_currency(self.company)
	...
	def get_unmarked_days_based_on_doj_or_relieving(
		...
		"""
		from parent_app.setup.doctype.employee.employee import is_holiday
	...
	def add_leave_balances(self):
		...
		if frappe.db.get_single_value("Payroll Settings", "show_leave_balances_in_salary_slip"):
			from hrdemo.hr.doctype.leave_application.leave_application import get_leave_details
