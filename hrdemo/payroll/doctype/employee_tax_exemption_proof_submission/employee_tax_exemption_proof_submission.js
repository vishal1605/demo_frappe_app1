	...
	refresh: function(frm) {
		if(frm.doc.docstatus === 0) {
			...
			frm.add_custom_button(__('Get Details From Declaration'), function() {
				parent_app.utils.map_current_doc({
					method: "hrdemo.payroll.doctype.employee_tax_exemption_declaration.employee_tax_exemption_declaration.make_proof_submission",
