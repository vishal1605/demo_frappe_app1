...
import parent_app
from parent_app.accounts.utils import get_fiscal_year, getdate, nowdate
...
from hrdemo.payroll.doctype.payroll_entry.payroll_entry import (
	PayrollEntry,
	get_end_date,
	get_start_end_dates,
)
...
def get_payroll_entry(**args):
	...
	payroll_entry.company = args.company or parent_app.get_default_company()
...
def get_payment_account():
	return frappe.get_value(
		"Account",
		{"account_type": "Cash", "company": parent_app.get_default_company(), "is_group": 0},
		"name",
	)
