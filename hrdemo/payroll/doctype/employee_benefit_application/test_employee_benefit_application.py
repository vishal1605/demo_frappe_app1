...
from parent_app.setup.doctype.holiday_list.test_holiday_list import set_holiday_list

from hrdemo.hr.utils import get_holiday_dates_for_employee
...
from hrdemo.payroll.doctype.salary_slip.test_salary_slip import (
	make_holiday_list,
