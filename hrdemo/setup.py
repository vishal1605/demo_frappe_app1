...
# from hrdemo.subscription_utils import update_erpnext_access
from hrdemo.overrides.company import delete_company_fixtures
...
def setup_notifications():
	base_path = frappe.get_app_path("hrdemo", "hr", "doctype")
...
def run_post_install_patches():
	...
	try:
		for patch in POST_INSTALL_PATCHES:
			...
			frappe.get_attr(f"hrdemo.patches.post_install.{patch_name}.execute")()
	finally:
