...
from hrdemo.hr.doctype.leave_application.test_leave_application import get_first_sunday
...
class TestShiftType(FrappeTestCase):
	...
	def test_mark_attendance(self):
		from hrdemo.hr.doctype.employee_checkin.test_employee_checkin import make_checkin
