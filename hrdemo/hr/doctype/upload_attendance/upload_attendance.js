...
hrdemo.hr.AttendanceControlPanel = class AttendanceControlPanel extends frappe.ui.form.Controller {
	onload() {
	...
	get_template() {
		...
		window.location.href = repl(frappe.request.url +
			...
			cmd: "hrdemo.hr.doctype.upload_attendance.upload_attendance.get_template",
	...
	show_upload() {
		...
		new frappe.ui.FileUploader({
			wrapper: $wrapper,
			method: 'hrdemo.hr.doctype.upload_attendance.upload_attendance.upload'
		});
	}
...
cur_frm.cscript = new hrdemo.hr.AttendanceControlPanel({frm: cur_frm});
