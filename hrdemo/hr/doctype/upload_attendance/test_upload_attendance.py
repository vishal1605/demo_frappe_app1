...
from hrdemo.hr.doctype.upload_attendance.upload_attendance import get_data
...
class TestUploadAttendance(unittest.TestCase):
	...
	def setUpClass(cls):
		frappe.db.set_value(
			"Company", parent_app.get_default_company(), "default_holiday_list", "_Test Holiday List"
		)
