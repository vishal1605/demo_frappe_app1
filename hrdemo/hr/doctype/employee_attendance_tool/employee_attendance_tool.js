frappe.ui.form.on("Employee Attendance Tool", {
	...
	load_employees(frm) {
		...
		frappe.call({
			method: "hrdemo.hr.doctype.employee_attendance_tool.employee_attendance_tool.get_employees",
			args: {
				date: frm.doc.date,
	...
	mark_attendance(frm) {
		...
		frappe.call({
			method: "hrdemo.hr.doctype.employee_attendance_tool.employee_attendance_tool.mark_employee_attendance",
			args: {
