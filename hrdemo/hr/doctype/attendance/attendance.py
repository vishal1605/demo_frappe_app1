...
from hrdemo.hr.doctype.shift_assignment.shift_assignment import has_overlapping_timings
...
class Attendance(Document):
	def validate(self):
		from parent_app.controllers.status_updater import validate_status
