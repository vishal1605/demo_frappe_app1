...
from hrdemo.hr.doctype.leave_period.test_leave_period import create_leave_period
from hrdemo.hr.doctype.leave_policy.test_leave_policy import create_leave_policy
