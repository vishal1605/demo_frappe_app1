...
from hrdemo.hr.doctype.employee_advance.employee_advance import (
	EmployeeAdvanceOverPayment,
	create_return_through_additional_salary,
	make_bank_entry,
	make_return_entry,
)
from hrdemo.hr.doctype.expense_claim.expense_claim import get_advances
from hrdemo.hr.doctype.expense_claim.test_expense_claim import (
	get_payable_account,
	make_expense_claim,
)
from hrdemo.payroll.doctype.salary_component.test_salary_component import create_salary_component
...
def make_employee_advance(employee_name, args=None):
	...
	doc.currency = parent_app.get_company_currency("_Test company")
	doc.exchange_rate = 1
