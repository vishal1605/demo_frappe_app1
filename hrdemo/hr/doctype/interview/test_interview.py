...
from hrdemo.hr.doctype.interview.interview import DuplicateInterviewRoundError
from hrdemo.hr.doctype.job_applicant.job_applicant import get_interview_details
from hrdemo.hr.doctype.job_applicant.test_job_applicant import create_job_applicant
...
class TestInterview(unittest.TestCase):
	...
	def test_notification_for_scheduling(self):
		from hrdemo.hr.doctype.interview.interview import send_interview_reminder
	...
	def test_notification_for_feedback_submission(self):
		from hrdemo.hr.doctype.interview.interview import send_daily_feedback_reminder
