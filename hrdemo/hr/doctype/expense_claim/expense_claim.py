...
import parent_app
# from parent_app.accounts.doctype.sales_invoice.sales_invoice import get_bank_cash_account
from parent_app.accounts.general_ledger import make_gl_entries
from parent_app.controllers.accounts_controller import AccountsController

from hrdemo.hr.utils import set_employee_name, share_doc_with_approver, validate_active_employee
...
def make_bank_entry(dt, dn):
	from parent_app.accounts.doctype.journal_entry.journal_entry import get_default_bank_cash_account
	...
	je.append(
		"accounts",
		{
			...
			"cost_center": parent_app.get_default_cost_center(expense_claim.company),
...
def get_expense_claim_account_and_cost_center(expense_claim_type, company):
	...
	cost_center = parent_app.get_default_cost_center(company)
