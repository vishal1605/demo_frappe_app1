...
from parent_app.accounts.doctype.account.test_account import create_account
from parent_app.accounts.doctype.payment_entry.test_payment_entry import get_payment_entry
from parent_app.setup.doctype.employee.test_employee import make_employee

from hrdemo.hr.doctype.expense_claim.expense_claim import (
	make_bank_entry,
...
class TestExpenseClaim(FrappeTestCase):
	...
	def test_expense_claim_against_fully_paid_advances(self):
		from hrdemo.hr.doctype.employee_advance.test_employee_advance import (
	...
	def test_expense_claim_against_delivery_trip(self):
		from parent_app.stock.doctype.delivery_trip.test_delivery_trip import (
			create_address,
			create_delivery_trip,
			create_driver,
			create_vehicle,
		)
		from parent_app.tests.utils import create_test_contact_and_address
