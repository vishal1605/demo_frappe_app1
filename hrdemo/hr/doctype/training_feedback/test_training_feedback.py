...
from hrdemo.hr.doctype.training_event.test_training_event import (
	create_training_event,
	create_training_program,
)
from hrdemo.payroll.doctype.salary_structure.test_salary_structure import make_employee
