...
from parent_app.assets.doctype.asset.test_asset import create_asset_data
from parent_app.setup.doctype.employee.test_employee import make_employee
from parent_app.stock.doctype.purchase_receipt.test_purchase_receipt import make_purchase_receipt
