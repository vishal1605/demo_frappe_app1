...
import parent_app
from parent_app import get_company_currency
from parent_app.setup.doctype.employee.employee import (
...
def generate_leave_encashment():
	...
	from hrdemo.hr.doctype.leave_encashment.leave_encashment import create_leave_encashment
...
def validate_loan_repay_from_salary(doc, method=None):
	if doc.applicant_type == "Employee" and doc.repay_from_salary:
		from hrdemo.payroll.doctype.salary_structure_assignment.salary_structure_assignment import (
		...
		company_currency = parent_app.get_company_currency(doc.company)
