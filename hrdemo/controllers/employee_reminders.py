...
from parent_app.setup.doctype.employee.employee import get_all_employee_emails, get_employee_email

from hrdemo.hr.utils import get_holidays_for_employee
